                 ...
                 ?>
                  ...
                  <tr>
                     ...
                     <td> <?php echo $row['phone']; ?></td>
                         <td><button ><a href="grades.php?grades=<?php echo $row['canditatesnationalid']; ?>" style="color:black">ADD GRADES</a></button></td>
                     <td><button><a href="viewcanditates.php? delete=<?php echo $row['canditatesnationalid']; ?>">DELETE</a></button></td>
                     <td><button><a href="update.php?update=<?php echo $row['canditatesnationalid']; ?>">UPDATE</a></button></td>
